package com.lxxc.study.java.resourcebundle;
...
public class Messages {
	private static final String BUNDLE_NAME = "com.lxxc.study.java.resourcebundle.messages";
    ...
    public static void main(String[] args) {
		...
		System.out.println(getString("age", "28"));
		System.out.println(getString("habit", "study", "look"));
	}
}
